...
- 系统使用了MySQL 8 / nmap 32位，需要确保安装了Microsoft Visual C++ 2019 Redistributable Package（x86 and x64）以上版本
- 程序包目录结构
  bin：启动程序所在目录
...
1. 初始化失败
   若安全运维工具箱第一次运行时提示初始化失败，请检查安装路径中是否包含中文或特殊符号（如 “-”），检查是否安装Microsoft Visual C++ 2019 Redistributable Package x64版本。
2. 升级失败
...
5. 若资产测绘无结果，进程中无namp进程，检查是否安装Microsoft Visual C++ 2019 Redistributable Package x86版本
